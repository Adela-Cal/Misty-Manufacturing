    ...
    def test_second_partial_invoice(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Verify invoice number has ~2 suffix
                self.verify_invoice_number_suffix(invoice_id, "~2")
    ...
    def test_third_partial_invoice(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                # Verify invoice number has ~3 suffix
                self.verify_invoice_number_suffix(invoice_id, "~3")
