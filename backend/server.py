...
os.environ['XERO_REDIRECT_URI'] = 'https://machinery-timesheet.preview.emergentagent.com/api/xero/callback'
...
XERO_CALLBACK_URL = os.getenv("XERO_REDIRECT_URI", "https://machinery-timesheet.preview.emergentagent.com/api/xero/callback")
...
async def debug_xero_config():
    ...
    current_callback_url = "https://machinery-timesheet.preview.emergentagent.com/api/xero/callback"
...
async def get_xero_auth_url(current_user: dict = Depends(require_admin_or_manager)):
    ...
    return {"auth_url": auth_url, "state": state, "debug_info": {
        "client_id": XERO_CLIENT_ID,
        "callback_url": "https://machinery-timesheet.preview.emergentagent.com/api/xero/callback",
        "scopes": XERO_SCOPES
    }}
