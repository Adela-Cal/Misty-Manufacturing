...
os.environ['XERO_REDIRECT_URI'] = 'https://jobcard-system.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://jobcard-system.preview.emergentagent.com'
