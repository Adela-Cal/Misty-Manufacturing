...
os.environ['XERO_REDIRECT_URI'] = 'https://misty-manufact.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://misty-manufact.preview.emergentagent.com'
