...
os.environ['XERO_REDIRECT_URI'] = 'https://factoryforge.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://factoryforge.preview.emergentagent.com'
