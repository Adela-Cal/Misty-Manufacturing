...
os.environ['XERO_REDIRECT_URI'] = 'https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback'
os.environ['FRONTEND_URL'] = 'https://manuf-ui-fixes.preview.emergentagent.com'
...
XERO_CALLBACK_URL = "https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback"
...
async def debug_xero_config():
    ...
    current_callback_url = "https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback"
...
async def get_xero_auth_url(current_user: dict = Depends(require_admin_or_manager)):
    ...
    auth_params = {
        "response_type": "code",
        "client_id": XERO_CLIENT_ID,
        "redirect_uri": "https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback",
        "scope": XERO_SCOPES,
        "state": state
    }
    ...
    logger.info(f"Callback URL: https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback")
    logger.info(f"Scopes: {XERO_SCOPES}")
    
    return {"auth_url": auth_url, "state": state, "debug_info": {
        "client_id": XERO_CLIENT_ID,
        "callback_url": "https://manuf-ui-fixes.preview.emergentagent.com/api/xero/callback",
        "scopes": XERO_SCOPES
    }}
