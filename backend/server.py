...
os.environ['XERO_REDIRECT_URI'] = 'https://misty-mfg-app.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://misty-mfg-app.preview.emergentagent.com'
