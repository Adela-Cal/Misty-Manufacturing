...
os.environ['XERO_REDIRECT_URI'] = 'https://prod-management.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://prod-management.preview.emergentagent.com'
