...
os.environ['XERO_REDIRECT_URI'] = 'https://mfg-workflow.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://mfg-workflow.preview.emergentagent.com'
