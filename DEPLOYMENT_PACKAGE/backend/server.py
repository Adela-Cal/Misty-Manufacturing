...
os.environ['XERO_REDIRECT_URI'] = 'https://timesheet-manager-33.preview.emergentagent.com/xero-oauth-callback'
os.environ['FRONTEND_URL'] = 'https://timesheet-manager-33.preview.emergentagent.com'
...
async def generate_profitability_report(
    ...
    try:
        ...
        for order in orders:
            ...
            if job_card:
                # Get material layers from job card product specs
                product_specs = job_card.get("product_specs", {})
                material_layers = product_specs.get("material_layers", [])
