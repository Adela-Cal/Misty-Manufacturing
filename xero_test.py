    ...
    def test_xero_debug_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_callback = 'https://product-pulse-12.preview.emergentagent.com/api/xero/callback'
                ...
                expected_frontend = 'https://product-pulse-12.preview.emergentagent.com'
