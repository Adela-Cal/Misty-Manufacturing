    ...
    def test_xero_debug_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_callback = 'https://timesheet-manager-33.preview.emergentagent.com/api/xero/callback'
                ...
                expected_frontend = 'https://timesheet-manager-33.preview.emergentagent.com'
