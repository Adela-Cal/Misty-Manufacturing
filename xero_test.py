    ...
    def test_xero_debug_configuration(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                expected_callback = 'https://factory-tracker-5.preview.emergentagent.com/api/xero/callback'
                ...
                expected_frontend = 'https://factory-tracker-5.preview.emergentagent.com'
