            ...
            <div className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="bg-gray-800 rounded-lg p-4 text-sm">
                  <p className="text-gray-400">Employee: <span className="text-white">{payslipToDelete.payslip_data.employee.name}</span></p>
                  <p className="text-gray-400">Employee #: <span className="text-white">{payslipToDelete.payslip_data.employee.employee_number}</span></p>
                  <p className="text-gray-400">Pay Period: <span className="text-white">{payslipToDelete.payslip_data.pay_period.week_start} to {payslipToDelete.payslip_data.pay_period.week_end}</span></p>
                  <p className="text-gray-400">Net Pay: <span className="text-white">${payslipToDelete.payslip_data.net_pay.toFixed(2)}</span></p>
                </div>
              </div>
