  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submitData = {
        ...
        strength_quality_important: formData.product_type === 'paper_cores' ? formData.strength_quality_important : false,
        delivery_included: formData.product_type === 'paper_cores' ? formData.delivery_included : false,
        // Services and Deliveries fields
        service_delivery_subtype: formData.product_type === 'services_and_deliveries' ? formData.service_delivery_subtype : null,
        service_job_description: formData.product_type === 'services_and_deliveries' ? formData.service_job_description || null : null,
        service_time_required: formData.product_type === 'services_and_deliveries' ? formData.service_time_required || null : null,
        service_price: formData.product_type === 'services_and_deliveries' ? (formData.service_price ? parseFloat(formData.service_price) : null) : null,
        service_functions: formData.product_type === 'services_and_deliveries' ? formData.service_functions : [],
        delivery_from_address: formData.product_type === 'services_and_deliveries' ? formData.delivery_from_address || null : null,
        delivery_to_address: formData.product_type === 'services_and_deliveries' ? formData.delivery_to_address || null : null,
