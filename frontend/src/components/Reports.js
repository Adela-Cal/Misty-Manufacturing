                      ...
                      <div key={index} className="border border-gray-700 rounded-lg p-4 bg-gray-800/50">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <button
                              onClick={() => toggleCustomersView(product.product_info.product_id)}
                              className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded transition-colors text-sm"
                            >
                              <UserIcon className="h-4 w-4" />
                              {expandedCustomers[product.product_info.product_id] ? 'Hide' : 'Show'} Customers
                            </button>
                          </div>
                        </div>
