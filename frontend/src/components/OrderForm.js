                ...
                <div key={index} className="bg-gray-700 rounded-lg p-4">
                  ...
                  <div className="mb-4 p-3 bg-blue-900/10 border border-blue-600 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs mb-3">
                      ...
                      <div>
                        <span className="text-gray-400">Material Specs:</span>
                  ...
                  {materialAllocations[materialData.material_id] > 0 && (
                    <div className="mb-4 p-3 bg-green-900/20 border border-green-600 rounded-lg">
                      <div className="flex items-center justify-between text-sm mb-2">
                        <div>
                          <span className="text-green-300 font-medium">
                            Allocated: {materialAllocations[materialData.material_id].toFixed(1)}m
                          </span>
                          <span className="text-gray-400 ml-2">
                            of {materialData.required_quantity_meters.toFixed(1)}m required for {materialData.layer_position}
                          </span>
                        </div>
                      ...
                      <div className="text-xs text-green-200">
                        Remaining needed: {Math.max(0, materialData.required_quantity_meters - materialAllocations[materialData.material_id]).toFixed(1)}m
                      </div>
                    </div>
                  )}
